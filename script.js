...
// Contact form: show simple client-side success message (server endpoint required for real email)
document.getElementById('contact-form').addEventListener('submit', function(e){
  // if action still placeholder, stop and show hint
  if(this.action.includes('REPLACE_WITH')){
    e.preventDefault();
    alert('Form endpoint not configured. To receive messages: sign up at Formspree.io and replace the form action with your Formspree endpoint. Or remove this check to use another backend.');
  }
});
